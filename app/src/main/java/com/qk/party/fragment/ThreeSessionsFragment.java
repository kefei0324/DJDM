...
import com.qk.party.adapter.ThreeSessionsAdapter;
...
/**
 * @package： com.qk.party.fragment
 * @class: ThreeSessionsFragment
 * @author:  小飞
 * @date: 2017/10/30 17:20
 * @描述：
 */

public class ThreeSessionsFragment extends BaseFragment  implements NetworkView<List<ThreeSessionsBean>> {
    ...
    private List<ThreeSessionsBean> all = new ArrayList<>();
    private int page = 1;
    private ThreeSessionsAdapter adapter;
    @Override
    ...
    public void initFindViewById(View view) {
        ...
        presenter.getThreeSessions(ShardUtil.getPreferenceString(mActivity,"access_token")
    ...
    @Override
    public void success(List<ThreeSessionsBean> electionBeans) {
        try {
            ...
            if(page==1){
                all.clear();
                recycler.setAdapter(adapter = new ThreeSessionsAdapter(all));
            }
